...
installTheme(){
    cd /var/www/
    tar -cvf theme.tar.gz pterodactyl
    echo "Installing theme..."
    cd /var/www/pterodactyl
    rm -r theme
    git clone https://github.com/veruy2811/theme.git
    cd theme
    ...
    mv resources/scripts/theme.css /var/www/pterodactyl/resources/scripts/theme.css
...
repair(){
    bash <(curl https://raw.githubusercontent.com/veruy2811/theme/main/repair.sh)
}
